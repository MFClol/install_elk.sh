...
# =============================================================================
# 3.1. Удаляем автоматически сгенерированные сертификаты и keystore
#      (чтобы не конфликтовали с нашим конфигом, где безопасность отключена)
# =============================================================================
...
echo -e "${GREEN}✓ Ключи безопасности удалены${NC}"
